        ...
        {animales
          ...
          .map((animal) => (
            ...
            >
              ...
              <p className="text-xs italic text-gray-400 font-mono mb-2">{animal.breed}</p>
              <img
              ...
              <div className="flex justify-around text-sm">
                <button
    className="mt-2 p-2 bg-sky-800 hover:bg-sky-700 text-white rounded-full flex items-center space-x-2"
    onClick={() => redirect(`/modificar/${animal.id}`)}
                >
                  Modificar a  <span className="font-bold ml-1">{animal.name}</span>
                </button>
                <button
