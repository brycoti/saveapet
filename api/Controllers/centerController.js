...
const centerAnimal = async (req, res) => {
  try {
    // Asegúrate de obtener el CenterId de las cookies de la solicitud
    const centerId = req.id;  // Asume que el nombre de la cookie es 'centerId'

    // Utiliza `findAll` para obtener todos los perros donde el CenterId coincide con el obtenido de la cookie
